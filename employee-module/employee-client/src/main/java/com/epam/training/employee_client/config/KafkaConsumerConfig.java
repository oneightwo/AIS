package com.epam.training.employee_client.config;
...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<Long, DepartmentDto> kafkaListenerContainerFactory() {
    ...
    @Bean
    public ConsumerFactory<Long, DepartmentDto> consumerFactory() {
